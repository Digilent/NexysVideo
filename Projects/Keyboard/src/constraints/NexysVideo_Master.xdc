...
# HID port
set_property -dict { PACKAGE_PIN W17   IOSTANDARD LVCMOS33 } [get_ports { PS2Clk }]; #IO_L16N_T2_A15_D31_14 Sch=ps2_clk
set_property -dict { PACKAGE_PIN N13   IOSTANDARD LVCMOS33 } [get_ports { PS2Data }]; #IO_L23P_T3_A03_D19_14 Sch=ps2_data
