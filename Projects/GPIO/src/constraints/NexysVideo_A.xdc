...
#set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33     } [get_ports { xa_n[2] }]; #IO_L1N_T0_AD0N_15 Sch=xa_n[2]
#set_property -dict { PACKAGE_PIN H13   IOSTANDARD LVCMOS33     } [get_ports { xa_p[2] }]; #IO_L1P_T0_AD0P_15 Sch=xa_p[2]
