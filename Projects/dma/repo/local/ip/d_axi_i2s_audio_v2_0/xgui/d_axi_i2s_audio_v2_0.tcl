...
proc init_gui { IPINST } {
  ...
  set C_DATA_WIDTH  [  ipgui::add_param $IPINST -name "C_DATA_WIDTH" -parent ${Page_0} -display_name {C Data Width}]
  set_property tooltip {C Data Width} ${C_DATA_WIDTH}
  ...
  set BIDIRECTIONAL_CLK  [  ipgui::add_param $IPINST -name "BIDIRECTIONAL_CLK" -parent ${Page_0} -display_name {Enable Bidirectional Clock}]
  set_property tooltip {Enable Bidirectional Clock} ${BIDIRECTIONAL_CLK}
